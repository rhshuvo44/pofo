...
const Development = () => {
  return (
    <section
      className=" development wow animate__animated  animate__fadeIn"
      ...
      <div className="py-5">
        <div className="container py-5">
          <div className="row flex-row-reverse">
            ...
            <div
              className="col-md-7 wow animate__animated  animate__fadeInLeft"
      ...
      <div className="container develop-icon">
        ...
        <div className="row pb-5">
          <div className="col-md-4">
            <div
              className="wow animate__animated  animate__fadeUp mb-3"
